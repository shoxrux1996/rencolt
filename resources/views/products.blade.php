...
@section('content')
    ...
    <main id="cs7">
        <div class="container z-depth-7 example" id="cs10">
            <h2 class="h1-responsive font-weight-bold text-center" id="cs8"><span class="badge red darken-4" style="font-family: 'Headland One', serif; border-radius: 40px">{{$categor->getTranslatedAttribute('name')}} <i class="fa fa-list"></i></span></h2>
            <!--Section: Main info-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4" data-toggle="tooltip" data-placement="top" title="Нажмитье чтобы просмотреть подробнее">
                        ...
                        <div class="row card-body  text-center">
                            <div class="col-md-12">
                                <a href="{{route('product', $product->id)}}"><h4><span class="badge red darken-4 wow pulse infinite">{{$product->getTranslatedAttribute('name')}}</span></h4></a>
                            </div>
                        </div>
                    </div>
                    @endforeach

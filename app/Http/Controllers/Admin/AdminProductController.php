...
class AdminProductController extends Controller
{
    ...
    public function browse(){
    	$categories = Product::orderByDesc('created_at')->get();
    	return DataTables::of($categories)->rawColumns(['text_ru','text_uz', 'text_en'])->editColumn('images', function(Product $product){
